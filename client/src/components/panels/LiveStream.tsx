  ...
  if (!telemetry.liveUrl) {
    return (
      <div className="p-3 bg-black/50 h-full flex flex-col items-center justify-center overflow-hidden">
        <h2 className="text-sm font-bold mb-3 border-b border-houston-muted pb-1 w-full text-center">OFFICIAL LIVESTREAM</h2>
  ...
  return (
    <div className="bg-black h-full flex flex-col overflow-hidden relative">
      ...
      {isEmbed ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4 overflow-y-auto w-full pt-10" data-theme="dark">
          <Tweet id={tweetId} />
        </div>
      ) : telemetry.liveUrl.includes('youtube.com/results') ? (
        <div className="flex-1 flex flex-col items-center justify-center p-4">
          <p className="text-houston-green mb-4 text-center text-sm font-bold">NO OFFICIAL LINK PROVIDED YET</p>
          <p className="text-houston-muted mb-6 text-center text-xs">The API hasn't provided a live video URL for this upcoming launch.</p>
          <a 
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4">
          <p className="text-houston-green mb-4 text-center text-sm">EXTERNAL LIVESTREAM DETECTED</p>
          <a 
            href={telemetry.liveUrl} 
            target="_blank" 
            rel="noreferrer"
