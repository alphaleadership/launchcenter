...
export const VehicleSelection: React.FC = () => {
  ...
  return (
    <div className="p-3 bg-black/50 h-full overflow-y-auto">
      <h2 className="text-sm font-bold mb-3 border-b border-houston-muted pb-1">VEHICLE SELECTION</h2>
        ...
        {availableLaunchers.map(name => (
          <button
            ...
            className={cn(
              ...
              telemetry.launcher === name ? "bg-houston-green text-black border-houston-green" : "border-houston-muted hover:border-houston-green",
