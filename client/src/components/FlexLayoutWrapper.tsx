...
export const FlexLayoutWrapper: React.FC = () => {
  ...
  const factory = useCallback((node: TabNode) => {
    ...
    switch (component) {
      case 'VehicleSelection': return <VehicleSelection />;
      case 'MissionProfile': return <MissionProfile />;
      case 'SystemReadiness': return <SystemReadiness />;
      case 'CrewVitalSigns': return <CrewVitalSigns />;
      case 'PreFlightTimeline': return <PreFlightTimeline />;
      case 'AltitudeProfile': return <AltitudeProfile />;
      case 'VelocityAltitude': return <VelocityAltitude />;
      case 'Consumables': return <Consumables />;
      case 'EventLog': return <EventLog />;
      case 'LiveStream': return <LiveStream />;
      default: return <div>Component {component} not found</div>;
    }
  }, []);
